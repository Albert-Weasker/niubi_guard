...
> **正在被恶意 Issues 骚扰？** 任何维护者都可以为自己的仓库部署 Niubi Guard，也可以直接使用 [niubistar.com/guard](https://www.niubistar.com/guard) 的免费托管版本，或通过 [support@niubistar.com](mailto:support@niubistar.com) 联系我们，一起判断和处理正在发生的攻击。
