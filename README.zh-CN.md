...
> **不想自己部署？** 直接使用 [niubistar.com/guard](https://www.niubistar.com/guard) 的免费托管版本——无需任何配置。开源版本会持续优化。欢迎在 [GitHub](https://github.com/niubistar/niubi-guard/issues) 提交 Issue 和反馈。
